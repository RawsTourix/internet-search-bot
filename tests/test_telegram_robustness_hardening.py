...
class TelegramActiveAlbumTextJoinTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_text_uses_active_album_group_before_file_http_finishes(self):
        file_task = self.client.submit_envelope(
        ...
        self.assertEqual(self.requests[1]["source_group_id"], "album-1")
        ...
        self.assertIsNone(self.requests[2].get("source_group_id"))
