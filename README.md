...
*   **Ollama**: Платформа для запуска больших языковых моделей локально. Скачайте и установите Ollama с [ollama.com](https://ollama.com/). После установки вам нужно будет загрузить модель `llama3.1:8b-instruct-q4_K_M`.
