...
Особенно строго сохраняй все ограничения и критерии из current_goal.
Для структурированных коллекций не смешивай значения разных записей.
Не расшифровывай коды и не приписывай полям смысл, который явно не указан
в raw result.
Не утверждай, что запись соответствует критерию пользователя, если raw result
не подтверждает это явно.
